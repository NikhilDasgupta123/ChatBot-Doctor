...
def mergeLoader():
    ...
    st.session_state.loader_all = MergedDataLoader(loaders = [st.session_state.HeartComponentsloader,
                                                              st.session_state.clevelandclinicloader,
                                                              st.session_state.heartLocation])
